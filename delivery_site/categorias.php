              ...
              <div class="oh-desktop">
                ...
                <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                  <div class="unit flex-row flex-lg-column">
                    ...
                    <div class="unit-body">
                      <h6 class="product-title"><a title="<?php echo $descricao ?>" href="produtos-da-categoria-de-<?php echo $nome_url ?>" ><?php echo $nome ?></a></h6>
                      <div class="product-price-wrap">
                        <div class="product-price"><?php echo $produtos ?> Produtos </div>
                       
                      </div><a class="button button-sm button-secondary button-ujarak" href="produtos-da-categoria-de-<?php echo $nome_url ?>">Ver Produtos</a>
                    </div>
                  </div>
                </article>
              </div>
