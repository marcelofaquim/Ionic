...
echo '
                         ...
                         $res = $pdo->query("SELECT * from carrinho where cpf = '$cpf_usuario' and id_venda = 0 order by id desc limit 2");

                         $res_2 = $pdo->query("SELECT * from carrinho where cpf = '$cpf_usuario' and id_venda = 0 order by id asc");

                         $dados = $res->fetchAll(PDO::FETCH_ASSOC);
                         $dados_2 = $res_2->fetchAll(PDO::FETCH_ASSOC);

                         $linhas = count($dados);
                         $linhas_2 = count($dados_2);
                        ...
                        echo '  <div class="cart-inline-item">
                            <div class="unit align-items-center">
                              ...
                              <div class="unit-body">
                                ...
                                <a onclick="deletarCarrinhoCab('.$id_carrinho.')" id="btn-deletar" href="" class="ml-2" title="Remover Item do Carrinho">
                                ...
                                <div>
                                  <div class="group-xs group-inline-middle">
                                    <div class="table-cart-stepper">
                                     <div class="quantity">
                                      <input onchange="editarCarrinhoCab('.$id_carrinho.')" class="form-control" type="number" data-zeros="true" value="'.$quantidade.'" min="1" max="1000" id="quantidade">
                                      </div>
                                    </div>
...
<script type="text/javascript">
	 ...
	 $("#total_itens_2").text(itens);
   $("#total_itens_3").text(itens);
	 $("#valor_total_2").text(total);
</script>
